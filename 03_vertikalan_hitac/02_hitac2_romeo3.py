...
balon_w, balon_h = 2.3, 5.0   # dimenzije slike balona su iste kao dimenzije 
                              # gornje slike, a oko balona je transparentna pozadina
h0 = 0.2 # visina poda (prikazana kao 0)
h_b = (1 - 464/1200)*5.0 # Visina donje tacke balona u gornjoj slici = 1.077
...
def draw(m):
    ...
    Draw(sl_gore, sl_dole, balon, tekst_t, tekst_v, tekst_h)
